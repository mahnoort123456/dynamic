...
<header className="text-black-600 bg-gray-100 body-font text-[18px]">
  <div className="container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center">
    ...
    <nav className="md:ml-auto flex flex-wrap items-center text-base justify-center text-[#000] font-medium space-x-6">
      <button  className='cart-icon hover:text-[#007580]' onClick={handleClick} >
...
// </a>
// <nav className="md:ml-auto flex flex-wrap items-center text-base justify-center text-[#000] font-medium space-x-6">
// //         <Link href={'/cart'} className="hover:text-[#007580]">Cart</Link>  /** <FaCartShopping /> */
// //         <Link href={'/wishlist'} className="hover:text-[#007580]">Wishlist</Link> /** <FaRegHeart /> */
// //         <Link href={'/login'} className="hover:text-[#007580]">Sign</Link>  <FaUserCircle /> */
// //      </nav>
// //    </div>
// //  </header> */}